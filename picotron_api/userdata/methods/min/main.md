# min(lhs, rhs, [dest], [read_start], [write_start], [group_size], [read_increment], [write_increment], [group_count]): written

## Overview
Gets the smallest values between elements on the left and right hand sides.
...
The left hand side of the min operation.

### `rhs`: [userdata](/picotron_api/userdata/readme.md)|number
The right hand side of the min operation.
